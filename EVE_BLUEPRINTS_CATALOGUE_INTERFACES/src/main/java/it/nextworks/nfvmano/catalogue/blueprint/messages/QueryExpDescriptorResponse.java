...
public class QueryExpDescriptorResponse implements InterfaceMessage {

	private List<ExpDescriptor> expDescriptors = new ArrayList<>();

	public QueryExpDescriptorResponse() { }
	 ...
	 */
	public List<ExpDescriptor> getExpDescriptors() {
		return expDescriptors;
	}

	@Override
	public void isValid() throws MalformattedElementException {
		for (ExpDescriptor expd : expDescriptors) expd.isValid();
	}
