...
public interface TestCaseDescriptorRepository extends JpaRepository<TestCaseDescriptor, Long> {

	Optional<TestCaseDescriptor> findByTestCaseDescriptorId(String testCaseDescriptorId);
