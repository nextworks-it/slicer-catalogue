...
public class SecurityConfig extends KeycloakWebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(HttpMethod.GET,"/portal/catalogue/vsblueprint").hasAnyRole("ExperimentDeveloper", "Vertical", "Experimenter", "SiteManager")
                ...
                .antMatchers(HttpMethod.GET,"/portal/catalogue/ctxblueprint").hasAnyRole("ExperimentDeveloper", "Experimenter", "SiteManager")
                ...
                .antMatchers(HttpMethod.GET,"/portal/catalogue/testcaseblueprint").hasAnyRole("ExperimentDeveloper", "Experimenter", "SiteManager")
                ...
                .antMatchers(HttpMethod.GET,"/portal/catalogue/expblueprint").hasAnyRole("ExperimentDeveloper", "Experimenter", "SiteManager")
                ...
                .antMatchers(HttpMethod.GET,"/portal/catalogue/expdescriptor").hasAnyRole("Experimenter", "SiteManager")
                .anyRequest()
                .authenticated();
    }
